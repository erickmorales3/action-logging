...
<div class="content scaffold-list">
    ...
    <div class="pagination">
        <a href="${createLink(action: 'index', params: [offset: (params.offset? (params.int("offset") > 0? (params.int("offset") - 10) : 0) : 0)])}">Latest records</a>
    </div>
    <table>
        <thead>
        <tr>
        ...
        <g:if test="${events}">
            <g:each in="${events}" status="i" var="event">
                <tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
                    ...
                    <td>${event.userId}</td>
                    <td>${event.params}</td>
                    <td><a href="${createLink(action: "details", id: event.id, params: [offset: params.int("offset")])}">Details</a></td>
                </tr>
            </g:each>
        </g:if>
        <g:else>
